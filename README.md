...
<table>
  <tr>
    <td align="center" width="50%">
      ...
      <h4>⚙️ 活动管理</h4>
      <p>完整的活动CRUD操作，多视图管理</p>
    </td>
    <td align="center" width="50%">
      <img src="项目演示/活动管理（我创建的活动）.png" alt="我创建的活动" width="400"/>
      <h4>📝 我创建的活动</h4>
      <p>创建者专属管理界面，权限控制</p>
    </td>
  </tr>
  <tr>
    <td align="center" width="50%">
      <img src="项目演示/活动管理（我参加的活动）.png" alt="我参加的活动" width="400"/>
      <h4>🎯 我参加的活动</h4>
      <p>参与者视角的活动管理</p>
    </td>
    <td align="center" width="50%">
      <img src="项目演示/活动审核.png" alt="活动审核页面" width="400"/>
      <h4>✅ 活动审核</h4>
      <p>报名审核功能，状态管理</p>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="项目演示/活动审核2.png" alt="活动审核详情" width="400"/>
      <h4>📋 审核详情</h4>
      <p>详细的审核信息和操作界面</p>
    </td>
  </tr>
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="项目演示/我的订单.png" alt="我的订单页面" width="400"/>
      <h4>📋 我的订单</h4>
      <p>个人订单管理，状态追踪</p>
    </td>
    <td align="center" width="50%">
      <img src="项目演示/活动订单.png" alt="活动订单页面" width="400"/>
      <h4>💰 活动订单</h4>
      <p>活动相关订单详情管理</p>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="项目演示/活动订单2.png" alt="订单详情页面" width="400"/>
      <h4>📄 订单详情</h4>
      <p>详细的订单信息和支付状态</p>
    </td>
  </tr>
...
<table>
  <tr>
    <td align="center" width="50%">
      <img src="项目演示/签到管理.png" alt="签到管理页面" width="400"/>
      <h4>📍 签到管理</h4>
      <p>签到码生成，签到状态管理</p>
    </td>
    <td align="center" width="50%">
      <img src="项目演示/签到、评论.png" alt="签到评论页面" width="400"/>
      <h4>💬 签到与评论</h4>
      <p>用户签到和社交评论功能</p>
    </td>
  </tr>
  <tr>
    <td align="center">
      <img src="项目演示/签到、评论2.png" alt="评论互动页面" width="400"/>
      <h4>🗨️ 社交互动</h4>
      <p>评论点赞，社交互动体验</p>
    </td>
  </tr>
...
<table>
  <tr>
    <td align="center" width="50%">
      ...
      <h4>👤 个人信息</h4>
      <p>个性化资料展示，头像上传，照片墙功能</p>
    </td>
    <td align="center" width="50%">
      <img src="项目演示/编辑个人信息.png" alt="编辑个人信息页面" width="400"/>
      <h4>✏️ 个人信息编辑</h4>
      <p>资料编辑界面，实时保存，表单验证</p>
    </td>
  </tr>
</table>
...
| 👤 **个人中心** | 个人资料、报名记录 | JWT认证、文件上传 |
| ✏️ **个人信息编辑** | 资料编辑、实时保存 | 表单验证、用户体验 |
| 📅 **活动管理** | 创建、编辑、删除活动 | CRUD操作、权限控制 |
| 🎯 **我创建的活动** | 创建者专属管理界面 | 权限分离、状态管理 |
| 🏃‍♂️ **我参加的活动** | 参与者视角活动管理 | 用户体验、个性化展示 |
| ✅ **活动审核** | 报名审核、状态管理 | 工作流控制、批量操作 |
| 📝 **报名系统** | 在线报名、状态管理 | 实时更新、订单跟踪 |
| 📋 **订单管理** | 订单状态、支付管理 | 订单生命周期、支付集成 |
| 💰 **活动订单** | 活动相关订单详情 | 财务管理、数据统计 |
| 📍 **签到管理** | 签到码生成、签到管理 | 随机码算法、持久化存储 |
| 💬 **签到评论** | 签到与社交评论功能 | 社交互动、用户体验 |
| 🗨️ **社交互动** | 评论点赞、互动交流 | 社交算法、内容管理 |
...
- **订单管理**: 报名记录、支付状态、订单跟踪
- **活动订单**: 活动相关财务管理、收支统计
- **支付系统**: 在线支付、订单状态同步、退款处理

### 📍 签到管理系统
- **签到码生成**: 随机码算法、安全性保证、时效控制
- **签到管理**: 创建者权限、签到状态监控、数据统计
- **用户签到**: 便捷签到流程、状态反馈、防重复签到
- **签到记录**: 详细记录管理、导出功能、数据分析

### 💬 社交互动平台
- **评论系统**: 活动评价、星级评分、图片分享
- **点赞功能**: 智能点赞、每用户每评论只能点赞一次、视觉反馈
- **权限控制**: 评论权限预检查、只有参与者可评论
- **用户体验**: 内联评论表单、实时状态更新、平滑交互
- **数据完整性**: 外键安全删除、点赞记录管理
